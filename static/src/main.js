	...
	for (var i = -4; i <= 4; i++)
	{
		...
		switch(DRAW_GAME_ARRAY[PLAYER_POS.row - 2][PLAYER_POS.col + i])
		{
			...
			case 1:
				...
				break;
			case -1:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (TREE_WIDTH/2), SQUARE_ARRAY[square].cy - TREE_HEIGHT, TREE_WIDTH, TREE_HEIGHT);
				...
				break;
			case -2:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (BANK_WIDTH/2), SQUARE_ARRAY[square].cy - BANK_HEIGHT, BANK_WIDTH, BANK_HEIGHT);
	...
	for (var i = -3; i <= 3; i++)
	{
		switch(DRAW_GAME_ARRAY[PLAYER_POS.row - 1][PLAYER_POS.col + i])
		{
			...
			case 1:
				...
				break;
			case -1:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (TREE_WIDTH1/2), SQUARE_ARRAY[square].cy - TREE_HEIGHT1, TREE_WIDTH1, TREE_HEIGHT1);
				...
				break;
			case -2:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (BANK_WIDTH1/2), SQUARE_ARRAY[square].cy - BANK_HEIGHT1, BANK_WIDTH1, BANK_HEIGHT1);
	...
	for (var i = -2; i <= 2; i++)
	{
		switch(DRAW_GAME_ARRAY[PLAYER_POS.row][PLAYER_POS.col + i])
		{
			...
			case 1:
				...
				break;
			case -1:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (TREE_WIDTH2/2), SQUARE_ARRAY[square].cy - TREE_HEIGHT2, TREE_WIDTH2, TREE_HEIGHT2);
				...
				break;
			case -2:
				ctx.drawImage(SQUARE_ARRAY[square].img, SQUARE_ARRAY[square].cx - (BANK_WIDTH2/2), SQUARE_ARRAY[square].cy - BANK_HEIGHT2, BANK_WIDTH2, BANK_HEIGHT2);
